  ...
  if (!tweet) {
    if (staticData) {
      return (
        <div
          className={cn(
            "relative flex h-fit w-full max-w-lg flex-col gap-4 overflow-hidden rounded-xl border p-5 bg-background",
            props.className
          )}
        >
          <div className="flex flex-row items-start justify-between tracking-normal">
