...
import _pZv2dLryOJtteD7rdbGZ from '../unmerged_dictionary/navbar.json' with { type: 'json' };
import _SPwJItvpoYLrR2XcZTYZ from '../unmerged_dictionary/projects.json' with { type: 'json' };
import _jkdedkRivRnin4r4PqhG from '../unmerged_dictionary/skills.json' with { type: 'json' };
